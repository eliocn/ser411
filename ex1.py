...
os.chdir('/home/eliana/Desktop/pdi_avancado/ribeiro_dados')

# definições básicas

vector_file = "/home/eliana/Desktop/pdi_avancado/ribeiro_dados/focos/focos-2016.shp"

vector_file_base_name = os.path.basename(vector_file)

layer_name = os.path.splitext(vector_file_base_name)[0]

output_file_dir = "/home/eliana/Desktop/pdi_avancado/ribeiro_dados/focos"
